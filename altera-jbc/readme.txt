********************************************************************************************
		Jam STAPL Byte-Code Player Version 2.3.2 README 3/21/2025
********************************************************************************************
...
Jam STAPL Byte-Code File. Version 2.3 supports Jam STAPL Byte-Code Files (.jbc) that have been 
...
Directory   Filename                            Description
---------   --------                            ------------------------------------------
\make       \microsoft\nmake.mak		Make file compatible with Microsoft Visual
...
C. NEW IN VERSION 2.3
---------------------
Updates in the Jam STAPL Byte-Code Player version 2.3 include:
...
Jam STAPL Byte-Code Player Version 2.3
...
does not discuss customization of serial mode. 
...
steps outlined in Section D for debugging the Jam Player. 
...
H. SUPPORT
For additional support, submit a Service Request at http://www.intel.com/mysupport. Bugs or 
